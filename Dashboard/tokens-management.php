...
<body>
    ...
    <script>
        ...
        function loadMasterTokens() {
            fetch('admin/tokens.php?action=list&type=master')
                .then(r => r.json())
                .then(data => {
                    if (data.success) {
                        let html = '';
        ...
        function createMasterToken() {
            ...
            fetch('admin/tokens.php?action=create&type=master', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
        ...
        function regenerateMasterToken(id) {
            ...
            fetch('admin/tokens.php?action=regenerate&type=master', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
        ...
        function deleteMasterToken(id) {
            ...
            fetch('admin/tokens.php?action=delete&type=master', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
        ...
        function loadClientTokens() {
            fetch('admin/tokens.php?action=list&type=client')
                .then(r => r.json())
                .then(data => {
                    if (data.success) {
                        let html = '';
        ...
        function createClientToken() {
            ...
            fetch('admin/tokens.php?action=create&type=client', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
        ...
        function regenerateClientToken(id) {
            ...
            fetch('admin/tokens.php?action=regenerate&type=client', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
