  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <h2 className="text-xl font-bold text-gray-800 p-6 pb-4">Açık Pozisyonlar</h2>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="mt-1">
                        ...
                        <span className="ml-2 text-sm text-gray-600">{pos.volume} Lot</span>
                      </div>
                    </div>
                    <div className={`text-lg font-bold ${pos.profit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                      ${pos.profit?.toFixed(2) || '0.00'}
                    </div>
                  </div>
                  
                  <div className="text-sm text-gray-500 bg-gray-50 p-2 rounded">
                    Açılış Fiyatı: <span className="font-medium text-gray-700">{pos.open_price}</span>
                  </div>
                </div>
              ))}
            </div>
